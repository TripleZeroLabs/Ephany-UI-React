...
Update the  the VITE settings in the new `.env` file. If developing locally, most settings can stay the same, but you must add the Ephany API key generated by Ephany Framework (see README.md of Ephany-Framework repo)

```
VITE_API_KEY=YOUR-EPHANY-API-KEY
```
